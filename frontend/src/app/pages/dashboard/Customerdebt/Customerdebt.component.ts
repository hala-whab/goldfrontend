...
@Component({
  selector: 'ngx-Customerdebt',
  providers: [TBService],
  styleUrls: ['./Customerdebt.component.scss'],
  templateUrl: './Customerdebt.component.html',
})
export class CustomerdebtComponent  {
  customers: any[];
  devices: any[];
  customerId: string;
  filter: any = {};
...
setPage(page: number) {
  ...
  pay(debt){
    this.router.navigate(['pages/dashboard/debtpaymentdetails', this.id,this.remaning,this.gram_card_price,this.gram_cash_price]); 
  }
}
